...
void Screen::render()
{
   ...
   for (auto &asset_record : database.get_assets())
   {
      float xx = x + spacing_x * asset_i;
      frame_placement.position.x = xx;
      frame_placement.position.y = y;
      frame_placement.size.x = 32;
      frame_placement.size.y = 32;
      ...
      frame_placement.start_transform();
      {
         ...
         asset_placement.scale.x = 3.0f;
         asset_placement.scale.y = 3.0f;
